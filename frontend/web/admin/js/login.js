...
if (demoAccount) {
  demoAccount.innerHTML =
    'Tai khoan demo: <strong>tan1</strong> / <strong>1</strong><br>Role duoc phep vao: <strong>ADMIN</strong> hoac <strong>STAFF</strong>';
}
...
loginForm?.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    window.location.href = role === "STAFF" ? "machines.html" : "dashboard.html";
  } catch (error) {
